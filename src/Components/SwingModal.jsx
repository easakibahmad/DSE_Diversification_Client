...
const SwingModal = ({
  ...
  return (
    <>
      <dialog id="swing_modal" className="modal   text-white">
        <div className="modal-box 	bg-sky-950">
          <div className="sticky top-0 z-50  bg-white text-sky-950 pt-2">
            <div className="flex justify-between items-center mb-1 ">
              <h2 className=" font-bold text-md text-center mb-1 pl-2">
                Swing Trading Strategy Results ({fileName})
              </h2>
          ...
          <div className="grid grid-cols-1 gap-2 font-light">
            {swingPositionLogs?.map((data, index) => (
